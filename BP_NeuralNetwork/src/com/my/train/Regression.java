...
public class Regression {
    ...
    public static void main(String[] args) throws IOException{
      ...
      //计时
    	...
    	BufferedWriter bfwrite= new BufferedWriter(new FileWriter(
				OUTPUT_result+"result.csv",false));
   ...
   //   net.setListeners(new ScoreIterationListener(1)); //显示
    ...
    private static DataSetIterator getTrainingData(){
        ...
        INDArray inputNDArray17 = Nd4j.create(input17, new int[]{nSamples,1}); 
		...
		INDArray inputNDArray = Nd4j.hstack(inputNDArray0,inputNDArray1,inputNDArray2,inputNDArray3,inputNDArray4,
				...
				inputNDArray13,inputNDArray14,inputNDArray15,inputNDArray16,inputNDArray17,inputNDArray18,inputNDArray19);
